 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Albums" type="{xsd}CTAlbum" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetAlbumsListResponseBody {
     ...
     * 
     */
    public List<CTAlbum> getAlbums() {
        if (albums == null) {
            albums = new ArrayList<CTAlbum>();
        }
        return this.albums;
    }
